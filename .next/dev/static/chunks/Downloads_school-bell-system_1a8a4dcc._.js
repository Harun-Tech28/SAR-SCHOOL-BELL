                        ...
                        if (shouldTrigger) {
                            ...
                            switch(timetable.bellType){
                                case "announcement":
                                    ...
                                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$school$2d$bell$2d$system$2f$lib$2f$voice$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playAnnouncement"])(`Attention students and staff. ${timetable.name}. Please follow the schedule.`, settings.defaultVoice, settings.defaultLanguage);
                                    break;
                                case "chime":
                                    // Play chime sound then announcement
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$school$2d$bell$2d$system$2f$lib$2f$bell$2d$sounds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playBellSound"])("chime");
                                    setTimeout({
                                        "Dashboard.useEffect.checkTimetables": async ()=>{
                                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$school$2d$bell$2d$system$2f$lib$2f$voice$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playAnnouncement"])(`${timetable.name}`, settings.defaultVoice, settings.defaultLanguage);
                                        }
                                    }["Dashboard.useEffect.checkTimetables"], 1500);
                                    break;
                                case "bell":
                                default:
                                    ...
                                    setTimeout({
                                        "Dashboard.useEffect.checkTimetables": async ()=>{
                                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$school$2d$bell$2d$system$2f$lib$2f$voice$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playAnnouncement"])(`Bell ring for ${timetable.name}`, settings.defaultVoice, settings.defaultLanguage);
                                        }
                                    }["Dashboard.useEffect.checkTimetables"], 2000);
                                    break;
                            }
                        }
                    }
...
//# sourceMappingURL=Downloads_school-bell-system_1a8a4dcc._.js.map