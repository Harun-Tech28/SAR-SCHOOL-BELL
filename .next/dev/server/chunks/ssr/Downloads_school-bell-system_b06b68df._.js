...
function Timetable() {
    ...
    const getRecommendedVoice = (bellType)=>{
        ...
        return recommendations[bellType] || 'openai-nova';
    };
    ...
    const startEdit = (id)=>{
        ...
        if (timetable) {
            setFormData({
                ...
                bellType: timetable.bellType,
                voice: timetable.voice || "openai-nova",
...
//# sourceMappingURL=Downloads_school-bell-system_b06b68df._.js.map