...
class VoiceFallbackHandler {
    ...
    async tryNetworkTTS(text, language) {
        const { playGoogleTTS } = await __turbopack_context__.A("[project]/Downloads/school-bell-system/lib/google-tts.ts [app-ssr] (ecmascript, async loader)");
        ...
        const checkPrayerTimes = async ()=>{
            ...
            for (const [prayer, time] of Object.entries(settings.prayerTimes || {})){
                if (currentTime === time) {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$school$2d$bell$2d$system$2f$lib$2f$voice$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["playAzanCall"])(prayer);
                }
            }
        };
...
//# sourceMappingURL=Downloads_school-bell-system_c7981634._.js.map