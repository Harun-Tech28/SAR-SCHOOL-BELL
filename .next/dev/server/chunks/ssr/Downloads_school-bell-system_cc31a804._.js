...
class CompleteBellSystem {
    ...
    static async playBellSequence(bellName, message, options = {}) {
        const settings = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$school$2d$bell$2d$system$2f$lib$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStore"].getState().settings;
        const { bellType = "bell", voice = settings.defaultVoice, language = settings.defaultLanguage, repeatCount = settings.defaultRepeatCount, delayBetweenToneAndVoice = 1500, delayBetweenRepeats = 3000, useHighQualityVoice = true } = options;
...
//# sourceMappingURL=Downloads_school-bell-system_cc31a804._.js.map