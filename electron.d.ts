...
export interface ElectronAPI {
  ...
  setRunInBackground: (enabled: boolean) => Promise<{ success: boolean; enabled?: boolean; error?: string }>;
  getRunInBackground: () => Promise<{ success: boolean; enabled?: boolean; error?: string }>;
